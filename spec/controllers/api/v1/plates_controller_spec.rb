...
RSpec.describe Api::V1::PlatesController, type: :controller do
  ...
  describe 'GET #show' do
    it 'returns a successful response' do
      get :show, params: { id: plate.id }, format: :json
      expect(response).to have_http_status(:ok)
    end
  end
  ...
  describe 'PUT #update' do
    context 'with valid attributes' do
      it 'updates the plate' do
        put :update, params: { id: plate.id, plate: valid_attributes }, format: :json
        plate.reload
    ...
    context 'with invalid attributes' do
      it 'does not update the plate' do
        put :update, params: { id: plate.id, plate: invalid_attributes }, format: :json
        plate.reload
